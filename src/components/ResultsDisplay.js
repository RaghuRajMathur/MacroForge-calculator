...
import { Flame, Zap, Apple, Droplet, RotateCcw, Download, Info, Dumbbell, ChefHat, Calendar } from 'lucide-react'
      ...
      <div className={styles.resultsContent}>
        ...
        <div className={styles.resultsHeader}>
          ...
          <p className={styles.resultsSubtitle}>
            {getGoalInfo().title} - We&apos;ve calculated your personalized daily macro targets based on your goals and activity level
          </p>
          <div className={styles.goalBadge}>
            <span className={styles.deficitInfo}>{getGoalInfo().deficit}</span>
            <span className={styles.expectedResult}>{getGoalInfo().expectedLoss}</span>
          </div>
        </div>
        ...
        <div className={styles.statsGrid}>
          {stats.map((stat) => (
            <div key={stat.label} className={styles.statCard} style={{'--stat-color': `var(${stat.color})`}}>
        ...
        <div className={styles.tabContent}>
              ...
              <div className={styles.contentGrid}>
                ...
                <div className={styles.infoSection}>
                  ...
                  <div className={styles.bmrCard}>
                    <div className={styles.bmrLabel}>Basal Metabolic Rate</div>
                    <div className={styles.bmrValue}>{Math.round(bmr)}</div>
                    <div className={styles.bmrDesc}>calories burned at rest</div>
                  </div>

                  <div className={styles.macroList}>
                    <div className={styles.macroListTitle}>Why These Macros?</div>
                    
                    <div className={styles.macroItem}>
                      <div className={`${styles.macroDot} ${styles.protein}`}></div>
                      <div className={styles.macroText}>
                        <span className={styles.macroName}>Protein:</span> Essential for muscle growth, repair, and maintaining lean body mass.
                      </div>
                    </div>
                    
                    <div className={styles.macroItem}>
                      <div className={`${styles.macroDot} ${styles.carbs}`}></div>
                      <div className={styles.macroText}>
                        <span className={styles.macroName}>Carbs:</span> Your body&apos;s preferred fuel source for workouts and brain function.
                      </div>
                    </div>
                    
                    <div className={styles.macroItem}>
                      <div className={`${styles.macroDot} ${styles.fat}`}></div>
                      <div className={styles.macroText}>
                        <span className={styles.macroName}>Fat:</span> Critical for hormone production and vitamin absorption.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={styles.additionalInfo}>
                    <div className={styles.infoCard}>
                      ...
                      <div className={styles.infoCardValue}>
                        {goal === 'lose' ? '-0.5kg' : goal === 'gain' ? '+0.25kg' : '0kg'}
                      </div>
                    </div>
                    ...
                    <div className={styles.infoCard}>
                      ...
                      <div className={styles.infoCardValue}>
                        {goal === 'lose' ? '-500' : goal === 'gain' ? '+400' : '0'} cal
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={styles.tipsSection}>
                    <h4 className={styles.tipsTitle}>Progress Tracking Tips</h4>
                ...
                <div className={styles.timingGrid}>
                  <div className={styles.timingCard}>
                    ...
                    <div className={styles.timingMacros}>
                      ...
                      <span className={styles.timingDesc}>Quick energy source</span>
                    </div>
                  </div>
                  <div className={styles.timingCard}>
                    <div className={styles.timingMeal}>Post-Workout</div>
                    <div className={styles.timingMacros}>
                      <span className={styles.timingValue}>25-40g Protein</span>
                      <span className={styles.timingDesc}>Muscle recovery</span>
                    </div>
                  </div>
                  <div className={styles.timingCard}>
                    <div className={styles.timingMeal}>Before Bed</div>
                    <div className={styles.timingMacros}>
                      <span className={styles.timingValue}>15-20g Protein</span>
                      <span className={styles.timingDesc}>Overnight recovery</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'diet' && (
            <div className={styles.tabContentPadding}>
              <DietPlan macros={macros} goal={goal} calories={macros.calories || tdee} />
            </div>
          )}
        </div>
        ...
        <div className={styles.quickSummary}>
          ...
          <div className={styles.summaryGrid}>
            <div className={styles.summaryItem}>
              ...
              <span className={styles.summaryValue}>{macros.calories || tdee}</span>
            </div>
            <div className={styles.summaryItem}>
              <span className={styles.summaryLabel}>Protein %</span>
              <span className={styles.summaryValue}>
                {Math.round((macros.protein * 4) / (macros.calories || tdee) * 100)}%
              </span>
            </div>
            <div className={styles.summaryItem}>
              <span className={styles.summaryLabel}>Carbs %</span>
              <span className={styles.summaryValue}>
                {Math.round((macros.carbs * 4) / (macros.calories || tdee) * 100)}%
              </span>
            </div>
            <div className={styles.summaryItem}>
              <span className={styles.summaryLabel}>Fat %</span>
              <span className={styles.summaryValue}>
                {Math.round((macros.fat * 9) / (macros.calories || tdee) * 100)}%
              </span>
            </div>
          </div>
        </div>
        ...
        <div className={styles.footerInfo}>
          <p className={styles.disclaimer}>
            ...
            Individual results may vary. Consult with a healthcare professional or registered dietitian 
